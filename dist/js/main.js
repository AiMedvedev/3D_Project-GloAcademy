...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\r\n\r\n\r\n\r\n\r\nconst slider = () => {\r\n    \r\n    let timeInterval = 2000;\r\n    let currentSlide = 0;\r\n    let interval;\r\n    let dots;\r\n\r\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(() => {\r\n        let dot = document.createElement('li');\r\n        \r\n\r\n        dot.classList.add('dot');\r\n        Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(dot)\r\n\r\n        return Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\r\n    })\r\n\r\n    dots = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('.dot');\r\n    dots[currentSlide].classList.add('dot-active');\r\n\r\n    const prevSlide = (elems, index, strClass) => {\r\n        elems[index].classList.remove(strClass);\r\n    }\r\n    \r\n    const nextSlide = (elems, index, strClass) => {\r\n        elems[index].classList.add(strClass);\r\n    }\r\n\r\n    const autoSlide = () => {\r\n        prevSlide(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), currentSlide, 'portfolio-item-active');\r\n        prevSlide(dots, currentSlide, 'dot-active');\r\n        currentSlide++;\r\n\r\n        if (currentSlide >= Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())) {\r\n            currentSlide = 0;\r\n        }\r\n        nextSlide(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), currentSlide, 'portfolio-item-active');\r\n        nextSlide(dots, currentSlide, 'dot-active');\r\n    }\r\n\r\n    const startSlide = (timer = 4000) => {\r\n        interval = setInterval(autoSlide, timer)\r\n        \r\n    }\r\n    \r\n    const stopSlide = () => {\r\n        clearInterval(interval);\r\n    }\r\n\r\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('click', (e) => {\r\n        e.preventDefault();\r\n\r\n        if (!e.target.matches('.dot, .portfolio-btn')) {\r\n            return;\r\n        }\r\n    \r\n        prevSlide(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), currentSlide, 'portfolio-item-active');\r\n        prevSlide(dots, currentSlide, 'dot-active');\r\n\r\n        if (e.target.matches('#arrow-right')) {\r\n            currentSlide++;\r\n        } else if (e.target.matches('#arrow-left')) {\r\n            currentSlide--;\r\n        } else if (e.target.classList.contains('dot')) {\r\n            dots.forEach((dot, index) => {\r\n                if (e.target === dot) {\r\n                    currentSlide = index;\r\n                }\r\n            });\r\n        }\r\n\r\n        if (currentSlide >= Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())) {\r\n            currentSlide = 0;\r\n        }\r\n\r\n        if (currentSlide < 0) {\r\n            currentSlide = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()) - 1;\r\n        }\r\n        nextSlide(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), currentSlide, 'portfolio-item-active');\r\n        nextSlide(dots, currentSlide, 'dot-active');\r\n    })\r\n\r\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('mouseenter', (e) => {\r\n        if (e.target.matches('.dot, .portfolio-btn')) {\r\n            stopSlide();\r\n        }\r\n    }, true)\r\n\r\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module '.index.js'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('mouseleave', (e) => {\r\n        if (e.target.matches('.dot, .portfolio-btn')) {\r\n            startSlide(timeInterval);\r\n        }\r\n    }, true)\r\n\r\n    startSlide(timeInterval);\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (slider);\n\n//# sourceURL=webpack:///./modules/slider.js?");
